...
import 'package:belajar_flutter/pertemuan2/screen/components/favoritepage/favDB.dart';
import 'package:belajar_flutter/pertemuan2/screen/components/favoritepage/favModel.dart';
          ...
          Container(
            ...
            child: Stack(children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                        "The Official of " + widget.teams.strTeam.toString(),
                        style: TextStyle(
                          fontSize: 16,
                        ...
                        child: Row(
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                child: Image.network(
                                  "https://i.ibb.co/fk55ZTy/web.png",
                                  width: 36,
                                  height: 36,
                                ),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: Image.network(
                                  "https://i.ibb.co/61h5Wnb/instagram.png",
                                  width: 36,
                                  height: 36,
                                ),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: Image.network(
                                  "https://i.ibb.co/MgH7gRd/facebook.png",
                                  width: 36,
                                  height: 36,
                                ),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: Image.network(
                                  "https://i.ibb.co/WG1VwcZ/twitter.png",
                                  width: 36,
                                  height: 36,
                                ),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                child: Image.network(
                                  "https://i.ibb.co/XWrBh7r/youtube.png",
                                  width: 36,
                                  height: 36,
                                ),
                              ),
              ...
              Container(
                  ...
                  alignment: Alignment.bottomCenter,
                  child: Image.network(widget.teams.strTeamBanner.toString(),
                      fit: BoxFit.fill)),
